...
@section('doctor_select_add','active')
@section('page_title','manage_doctor')
@section('container')
                    ...
                    <form action="{{route('manage_doctor_process')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input id="brick_name" name="brick_name" type="text"
                                    value="{{old('brick_name',$brick_name)}}"
                                    class="form-control {{($errors->any() && $errors->first('brick_name'))?'is-invalid':''}} "
                                    required>
                                @if($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input id="pmdc_no" name="pmdc_no" type="number" value="{{old('pmdc_no',$pmdc_no)}}"
                                    class="form-control {{($errors->any() && $errors->first('pmdc_no'))?'is-invalid':''}} "
                                    required>
                                @if($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input id="dateof_birth" name="dateof_birth" type="date"
                                    value="{{old('dateof_birth',$dateof_birth)}}"
                            ...
                            <div class="form-group">
                                ...
                                <input id="cnic" name="cnic" type="text" value="{{old('cnic',$cnic)}}"
                                    class="form-control {{($errors->any() && $errors->first('cnic'))?'is-invalid':''}} "
                                    required
                            ...
                            <div class="form-group">
                                ...
                                <input id="mobile" name="mobile" type="text" value="{{old('mobile',$mobile)}}"
                                    class="form-control {{($errors->any() && $errors->first('mobile'))?'is-invalid':''}} "
                                    required
                                    oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');">
                                @if($errors->any())
                            ...
                            <div class="form-group">
                                ...
                                <input id="activity" name="activity" type="text" value="{{old('activity',$activity)}}"
                                    class="form-control {{($errors->any() && $errors->first('activity'))?'is-invalid':''}} "
                                    required>
                                @if($errors->any())
                                <p class="invalid-feedback">{{$errors->first('activity')}}</p>
                                @endif
                            </div>
